...
* Process: ![A rounded rectangle](icons/rounded-rectangle.png)A rounded rectangle.  Any running code, including compiled, scripts, shell commands, SQL stored procedures, et cetera.

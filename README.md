...
* Process: ![A rounded rectangle](icons/rounded-rectangle.png | width=90 )A rounded rectangle.  Any running code, including compiled, scripts, shell commands, SQL stored procedures, et cetera.
